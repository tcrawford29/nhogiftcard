 ...
 */
package com.nhogiftcard.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(NhogiftcardFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NhogiftcardFulfilmentProcessConstants.PARENT_PROCESS);
