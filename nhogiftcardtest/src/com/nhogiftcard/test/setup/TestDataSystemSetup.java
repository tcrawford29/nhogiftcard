 ...
 */
package com.nhogiftcard.test.setup;
...
import com.nhogiftcard.test.constants.NhogiftcardTestConstants;
import com.nhogiftcard.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = NhogiftcardTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/nhogiftcardtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/nhogiftcardtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/nhogiftcardtest/import/cstickets.impex");
			...
			importImpexFile(context, "/nhogiftcardtest/import/csquotes.impex");
		}
	}
}
