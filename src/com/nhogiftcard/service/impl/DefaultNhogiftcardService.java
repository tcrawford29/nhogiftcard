...
public class DefaultNhogiftcardService implements NhogiftcardService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultNhogiftcardService.class);
	...
	{
		return DefaultNhogiftcardService.class.getResourceAsStream("/nhogiftcard/sap-hybris-platform.png");
	}
