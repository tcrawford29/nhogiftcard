...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/nhogiftcardstorefront/electronics/en",
						"https://electronics.local:9002/nhogiftcardstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/nhogiftcardstorefront/electronics/en",
						"https://electronics.local:9002/nhogiftcardstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/nhogiftcardstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/nhogiftcardstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/nhogiftcardstorefront/electronics/en",
						"https://electronics.local:9002/nhogiftcardstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/nhogiftcardstorefront",
						"https://electronics.local:9002/nhogiftcardstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/nhogiftcardstorefront",
						"https://electronics.local:9002/nhogiftcardstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/nhogiftcardstorefront/electronics/en",
						"https://electronics.local:9002/nhogiftcardstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
